...
print('initial estimate', torch.nn.functional.softmax(model(x), dim=1).max())
...
# with open('stuff.pickle', 'wb') as file:
#     pickle.dump([x.cpu(), attacks, grads, dogs, hammers], file)
